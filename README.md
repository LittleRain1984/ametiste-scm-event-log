...
##### Response Format
Response return **200 OK** status and JSON object with status (*see com.dph.scm.log.data.replay.ReplayTaskStatus*). If task with this id not exists service returns **404 NOT FOUND** code and *reason* in body.
